...
export default function Navbar() {
  ...
  return (
    <nav className={cn(
      ...
      isLanding ? 'bg-transparent' : 'bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-b border-border dark:border-border-dark'
    )}>
        ...
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center gap-2 group">
            ...
            <span className={cn(
              ...
              isLanding ? 'text-white' : 'text-text dark:text-text-dark'
            )}>
            ...
            {NAV_ITEMS.public.map((item) => (
              <Link
                ...
                className={cn(
                  ...
                  location.pathname === item.href && (isLanding ? 'text-white bg-white/10' : 'text-primary bg-primary/5')
                )}
              >
                {item.label}
              </Link>
          ...
          <div className="hidden md:flex items-center gap-3">
            <button
              ...
              className={cn(
                ...
                isLanding ? 'text-white/70 hover:text-white hover:bg-white/10' : 'text-muted hover:bg-gray-100 dark:hover:bg-slate-800'
              )}
            >
              ...
              <>
                <Link
                  ...
                  className={cn(
                    ...
                    isLanding ? 'text-white/80 hover:text-white' : 'text-muted hover:text-text'
                  )}
                >
          ...
          <button
            ...
            className={cn('md:hidden p-2 rounded-lg', isLanding ? 'text-white' : 'text-text dark:text-text-dark')}
          >
