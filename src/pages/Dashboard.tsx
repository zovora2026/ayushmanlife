          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-muted leading-relaxed">
                Claim CLM-2026-0043 (Amit Singh) is approaching the 48-hour
                review deadline. Requires immediate attention.
              </p>
              <Link
                to="/claims"
                className="mt-2 inline-block text-xs font-semibold text-warning hover:underline"
              >
                Review Claim &rarr;
              </Link>
            </div>
        ...
        <Card className="border-accent/30 bg-accent/5 dark:bg-accent/10">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-muted leading-relaxed">
                Dr. Ravi Shankar&apos;s BLS certification expires on 5 Apr 2026.
                Schedule renewal before the deadline.
              </p>
              <Link
                to="/workforce"
        ...
        <Card className="border-error/30 bg-error/5 dark:bg-error/10">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-muted leading-relaxed">
                Sunita Devi (Age 67) — Risk Score 85. Vitals showing
                deterioration trend. BP 150/94, Blood Glucose 162.
              </p>
              <Link
                to="/dashboard"
                className="mt-2 inline-block text-xs font-semibold text-error hover:underline"
              >
                View Patient &rarr;
              </Link>
            </div>
